...
folder_name ="1200_2400" + time.strftime('%Y-%m-%d')
...
with open(f"1200_2400_data_bamper.csv", "w", encoding="utf-8") as file_data:
    ...
    for i in range(1, 61):
        ...
        for item in href_part:
            ...
            if num_provider not in black_list:
                ...
                file = open(f"1200_2400_data_bamper.csv", "a", encoding="utf-8", newline='')
