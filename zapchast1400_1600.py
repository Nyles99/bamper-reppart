...
folder_name ="1400_1600" + time.strftime('%Y-%m-%d')
...
with open(f"1400_1600_data_bamper.csv", "w", encoding="utf-8") as file_data:
...
with open("zapchast1400_1600.json", encoding="utf-8") as file:
    ...
    for i in range(1, 61):
        ...
        for item in href_part:
            ...
            if num_provider not in black_list:
                ...
                file = open(f"1400_1600_data_bamper.csv", "a", encoding="utf-8", newline='')
