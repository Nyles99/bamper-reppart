...
proxies = {
    'http': 'http://dmUq5yXN:gwR4xvLA@85.142.144.57:62580',
    'https': 'http://dmUq5yXN:gwR4xvLA@85.142.144.57:62580'
}
...
if os.path.exists(f"00_1200_year_price_one_year_data_bamper.csv"):
    print("Папка уже есть")
else:
    with open(f"00_1200_year_price_one_year_data_bamper.csv", "w", encoding="utf-8") as file_data:
...
with open("zapchast00_1200_year_price_one_year.json", encoding="utf-8") as file:
                ...
                for item in href_part:
                    ...
                    if num_provider not in black_list:
                        try:
                            ...
                            file = open(f"00_1200_year_price_one_year_data_bamper.csv", "a", encoding="utf-8", newline='')
