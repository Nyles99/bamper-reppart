...
folder_name ="500_600_" + time.strftime('%Y-%m-%d')
...
with open(f"500_600_data_bamper.csv", "w", encoding="utf-8") as file_data:
...
with open("zapchast500_600.json", encoding="utf-8") as file:
    ...
    for i in range(1, number_page+1):
        ...
        for item in href_part:
            ...
            if num_provider not in black_list:
                ...
                file = open(f"500_600_data_bamper.csv", "a", encoding="utf-8", newline='')
