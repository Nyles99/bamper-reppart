...
folder_name ="1900_2000" + time.strftime('%Y-%m-%d')
...
with open(f"1900_2000_data_bamper.csv", "w", encoding="utf-8") as file_data:
...
with open("zapchast1900_2000.json", encoding="utf-8") as file:
    ...
    for i in range(1, 61):
        ...
        for item in href_part:
            ...
            if num_provider not in black_list:
                ...
                file = open(f"1900_2000_data_bamper.csv", "a", encoding="utf-8", newline='')
