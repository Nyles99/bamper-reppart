...
folder_name ="2000_2200" + time.strftime('%Y-%m-%d')
...
with open(f"2000_2200_data_bamper.csv", "w", encoding="utf-8") as file_data:
...
with open("zapchast2000_2200.json", encoding="utf-8") as file:
...
for item_href_categories, number_page in srazy_parsim.items():
    ...
    #print(modelh)
    for i in range(1, 61):
        item_href_categories = f"https://bamper.by/zchbu/marka_{markah}/model_{modelh}/god_2012-2023/price-ot_70/store_Y/?ACTION=REWRITED3&FORM_DATA=marka_{markah}%2Fmodel_{modelh}%2Fgod_2012-2023%2Fprice-ot_70&2Fstore_Y&sort=PRICE-ASC&more=Y&PAGEN_1={i}"
        ...
        for item in href_part:
            ...
            if num_provider not in black_list:
                ...
                file = open(f"2000_2200_data_bamper.csv", "a", encoding="utf-8", newline='')
