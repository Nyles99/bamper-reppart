...
folder_name ="400_500_" + time.strftime('%Y-%m-%d')
...
with open(f"400_500_data_bamper.csv", "w", encoding="utf-8") as file_data:
...
with open("zapchast400_500.json", encoding="utf-8") as file:
    ...
    for i in range(1, number_page+1):
        ...
        for item in href_part:
            ...
            if num_provider not in black_list:
                ...
                file = open(f"400_500_data_bamper.csv", "a", encoding="utf-8", newline='')
